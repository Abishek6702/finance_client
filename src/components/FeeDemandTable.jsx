...
export default function FeeDemandTable({
  ...
  return (
    <div className="w-full bg-white rounded-2xl  ">
      <div
        className="max-h-[calc(100vh-260px)] overflow-auto rounded-2xl"
        ...
        <table className="w-full">
          <thead className="sticky top-0 z-30">
            <tr className="bg-[#F0F0F0]">
              ...
              <th className="p-3 text-center font-semibold">Student Details</th>

              <th className="p-3 text-center font-semibold">Roll Number</th>

              <th className="p-3 text-center font-semibold">Department</th>
              <th className="p-3 text-center font-semibold">Year</th>
              <th className="p-3 text-center font-semibold">Section</th>

              <th className="p-3 text-center font-semibold">Type</th>

              <th className="p-3 text-center font-semibold">Change Status </th>
            </tr>
          </thead>
