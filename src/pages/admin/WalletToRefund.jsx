...
import FeeSearchFilterRefund from "../../components/FeeSearchFilterRefund";
          ...
          <div className="w-full bg-white border border-gray-100 rounded-2xl flex flex-col p-4 shadow-sm">
            {selectedStudent ? (
              ...
              <div className="max-w-md mx-auto mt-10 text-center">
                <img
                  src={selectedStudent.img || EmptyImage}
              ...
              <div className="max-w-sm mx-auto mt-20 text-center">
                <img
                  src={EmptyImage}
                  alt="Select student"
                  className="w-40 mb-8 mx-auto opacity-80"
                />

                <h2 className="text-xl font-semibold text-gray-800 mb-3">
                  {loading
                    ? "Searching..."
                    : "Search & Select Student to proceed"}
                </h2>
