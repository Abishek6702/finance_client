  ...
  const fetchStudent = async () => {
    try {
      ...
      const formattedStudent = {
        ...
        fatherName: data?.contact?.father?.name || "",
        fatherPhone: data?.contact?.father?.phoneNumber || "",
        motherName: data?.contact?.mother?.name || "",
        motherPhone: data?.contact?.mother?.phoneNumber || "",
      ...
      console.log("Contact object:", data.contact);
